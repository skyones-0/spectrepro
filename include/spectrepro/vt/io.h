 ...
 * @file io.h
 *
 * Generic IO callbacks for libspectrepro-vt.
 */

#ifndef SPECTREPRO_VT_IO_H
#define SPECTREPRO_VT_IO_H
 ...
 * lifetime documented by the API receiving a SpectreProReader or SpectreProWriter.
 *
 * @{
 */
 ...
 *
 * @param userdata Opaque userdata from SpectreProReader
 ...
 */
typedef bool (*SpectreProReaderFn)(
    void* userdata,
    uint8_t* buffer,
    size_t capacity,
    size_t* out_read);
 ...
 *
 * @param userdata Opaque userdata from SpectreProWriter
 ...
 */
typedef bool (*SpectreProWriterFn)(
    void* userdata,
    const uint8_t* data,
    size_t len);
 ...
 * SpectreProMimeReader defines which MIME types are requested, how many
 * times, and any consistency requirements across repeated reads.
 *
 * @param userdata Opaque userdata from SpectreProMimeReader
 ...
 */
typedef bool (*SpectreProMimeReaderFn)(
    void* userdata,
 ...
 */
typedef struct {
    SpectreProMimeReaderFn read;
    void* userdata;
} SpectreProMimeReader;
