...
This example demonstrates how to use the SpectrePro VT library from WebAssembly
...
This will create `zig-out/bin/spectrepro-vt.wasm`.
...
From the **root of the spectrepro repository**, serve with a local HTTP server:
