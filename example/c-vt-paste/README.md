# Example: `spectrepro-vt` Paste

This contains a simple example of how to paste into a `spectrepro-vt`
terminal with `spectrepro_terminal_paste`: plain and bracketed (mode 2004)
