...
int main() {
  ...
  SpectreProFormatterTerminalOptions fmt_opts = SPECTREPRO_INIT_SIZED(SpectreProFormatterTerminalOptions);
  ...
  SpectreProWriter writer = {.write = write_output, .userdata = &output};
  printf("Formatted output:\n");
  result = spectrepro_formatter_format(formatter, writer);
  assert(result == SPECTREPRO_SUCCESS);
  printf("\n(%zu bytes)\n", output.written);
