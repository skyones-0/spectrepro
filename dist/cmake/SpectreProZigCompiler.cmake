# SpectreProZigCompiler.cmake — set up zig cc as a cross compiler
#
# Provides spectrepro_zig_compiler() which configures zig cc / zig c++ as
...
#
# This file is self-contained with no dependencies on the spectrepro
...
function(spectrepro_zig_compiler)
    cmake_parse_arguments(PARSE_ARGV 0 _GZC "" "ZIG_TARGET" "")

    if(NOT _GZC_ZIG_TARGET)
        message(FATAL_ERROR "spectrepro_zig_compiler: ZIG_TARGET is required")
    endif()
