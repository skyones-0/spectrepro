...
For user documentation, see the main README or [spectrepro.org](https://spectrepro.org/docs).
...
in `list_keybinds.zig` contains the help text for `spectrepro +list-keybinds`.
