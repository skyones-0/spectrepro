...
const Boo = struct {
    ...
    fn updateFrame(self: *Boo) void {
        ...
        while (line_iter.next()) |line| {
            ...
            var style = self.spectrepro_style;
...
/// The `boo` command is used to display the animation from the SpectrePro website in the terminal
