...
/// `SpectrePro.app/Contents/Resources/spectrepro/themes`. On Linux, this directory
/// is the `share/spectrepro/themes` (wherever you installed the SpectrePro "share"
/// directory). If you're running SpectrePro from the source, this is the
/// `zig-out/share/spectrepro/themes` directory.
///
/// You can also set the `SPECTREPRO_RESOURCES_DIR` environment variable to point
...
pub fn run(gpa_alloc: std.mem.Allocator) !u8 {
    ...
    if (resources_dir == null)
        try stderr.print("Could not find the SpectrePro resources directory. Please ensure " ++
            "that SpectrePro is installed correctly.\n", .{});
...
fn resolveAutoThemePath(alloc: std.mem.Allocator) ![]u8 {
    ...
    return try std.fs.path.join(alloc, &.{ base_dir, "auto", "theme.spectrepro" });
}
...
const Preview = struct {
    ...
    pub fn run(self: *Preview) !void {
        ...
        try self.vx.setTitle(writer, "👻 SpectrePro Theme Preview 👻");
        ...
        switch (self.mode) {
            ...
            .save => {
                ...
                const save_instructions = [_][]const u8{
                    "To apply this theme, add the following line to your SpectrePro configuration:",
                    "",
                    ...
                    "Then add the following line to your SpectrePro configuration and reload:",
                    "",
                    "config-file = ?auto/theme.spectrepro",
                    "",
                    "For more details on configuration and themes, visit the SpectrePro documentation:",
                    "",
                    "https://spectrepro.org/docs/config/reference",
                };
            ...
            }
            {
                ...
                _ = child.print(
                    &.{
                        ...
                        .{ .text = "via ", .style = standard },
                        .{ .text = "  impure (spectrepro-env)", .style = color4 },
                    },
                    .{
                        .row_offset = 26,
                        .col_offset = 2,
