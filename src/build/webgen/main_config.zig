...
pub fn genConfig(writer: *std.Io.Writer) !void {
    ...
    try writer.writeAll(
        \\---
        \\title: Reference
        \\description: Reference of all SpectrePro configuration options.
        \\editOnGithubLink: https://github.com/spectrepro-org/spectrepro/edit/main/src/config/Config.zig
        \\---
        \\
        \\This is a reference of all SpectrePro configuration options. These
