//! SpectreProFrameData generates a compressed file and zig module which contains (and exposes) the
//! SpectrePro animation frames for use in `spectrepro +boo`
const SpectreProFrameData = @This();
...
pub fn init(b: *std.Build) !SpectreProFrameData {
...
pub fn addImport(self: *const SpectreProFrameData, step: *std.Build.Step.Compile) void {
