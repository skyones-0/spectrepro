...
pub const tables = [_]config.Table{
    ...
    .{
        ...
        //
        // SpectrePro does not hit this, because its own uses of these fields go
...
const WidthComponent = struct {
    pub fn build(
        ...
        // This condition is needed as SpectrePro currently has a singular concept for
        ...
        // SpectrePro's current width 0 handling. Future work will take advantage of
