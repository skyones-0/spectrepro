% SPECTREPRO(1) Version @@VERSION@@ | SpectrePro terminal emulator

# NAME

**spectrepro** - SpectrePro terminal emulator

# DESCRIPTION

SpectrePro is a cross-platform, GPU-accelerated terminal emulator that aims to push
...
The unique goal of SpectrePro is to have a platform for experimenting with modern,
...
While aiming for this ambitious goal, SpectrePro is a fully standards compliant
