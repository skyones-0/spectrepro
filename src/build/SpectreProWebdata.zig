//! SpectreProWebdata generates all the SpectrePro website data that is
//! merged with the website for things like config references.
const SpectreProWebdata = @This();
...
pub fn init(
...

    {
        ...
        try steps.append(b.allocator, &b.addInstallFile(
            webgen_config_out,
            "share/spectrepro/webdata/config.mdx",
        ).step);
    }

    {
        ...
        try steps.append(b.allocator, &b.addInstallFile(
            webgen_actions_out,
            "share/spectrepro/webdata/actions.mdx",
        ).step);
    }

    {
        ...
        try steps.append(b.allocator, &b.addInstallFile(
            webgen_commands_out,
            "share/spectrepro/webdata/commands.mdx",
        ).step);
    }
...
pub fn install(self: *const SpectreProWebdata) void {
