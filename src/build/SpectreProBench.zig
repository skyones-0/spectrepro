//! SpectreProBench generates all the SpectrePro benchmark helper binaries.
const SpectreProBench = @This();
...
pub fn install(self: *const SpectreProBench) void {
