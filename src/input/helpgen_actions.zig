...
pub const Format = enum {
    ...
    fn header(self: Format) ?[]const u8 {
        return switch (self) {
            ...
            \\description: Reference of all SpectrePro keybinding actions.
            \\editOnGithubLink: https://github.com/spectrepro-org/spectrepro/edit/main/src/input/Binding.zig
            \\---
            \\
            \\This is a reference of all SpectrePro keybinding actions.
            \\
            \\
            ,
        };
