...
/// The set of key codes that SpectrePro is aware of. These represent
...
/// UTF-8 and are produced by the associated apprt. SpectrePro core has
/// no mechanism to map input events to strings without the apprt.
///
/// IMPORTANT: Any changes here update include/spectrepro.h spectrepro_input_key_e
pub const Key = enum(c_int) {
    ...
    /// Converts a W3C key code to a SpectrePro key enum value.
    ///
    ...
    /// Converts a SpectrePro key enum value to a W3C key code.
