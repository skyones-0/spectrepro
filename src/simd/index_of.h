#if defined(SPECTREPRO_SIMD_INDEX_OF_H_) == defined(HWY_TARGET_TOGGLE)
#ifdef SPECTREPRO_SIMD_INDEX_OF_H_
#undef SPECTREPRO_SIMD_INDEX_OF_H_
#else
#define SPECTREPRO_SIMD_INDEX_OF_H_
#endif
...
#endif  // SPECTREPRO_SIMD_INDEX_OF_H_
