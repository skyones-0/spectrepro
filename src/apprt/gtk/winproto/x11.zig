//! X11 window protocol implementation for the SpectrePro GTK apprt.
...
pub const App = struct {
    ...
    pub fn init(
        ...
        //
        //     WM_CLASS(STRING) = "spectrepro", "co.skyones.spectrepro"
        //
...
pub const Window = struct {
    ...
    // with some window managers: https://github.com/spectrepro-org/spectrepro/pull/8075
