...
const log = std.log.scoped(.gtk_spectrepro_close_confirmation_dialog);
...
pub const CloseConfirmationDialog = extern struct {
    ...
    pub const getGObjectType = gobject.ext.defineClass(Self, .{
        .name = "SpectreProCloseConfirmationDialog",
        .instanceInit = &init,
...
pub const Target = enum(c_int) {
    ...
    pub const getGObjectType = gobject.ext.defineEnum(
        Target,
        .{ .name = "SpectreProCloseConfirmationDialogTarget" },
    );
};
