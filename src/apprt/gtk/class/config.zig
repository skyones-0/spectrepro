...
const log = std.log.scoped(.gtk_spectrepro_config);

/// Wraps a `SpectrePro.Config` object in a GObject so it can be reference
...
pub const Config = extern struct {
    ...
    /// Create a new SpectreProConfig from a loaded configuration.
    ///
