...
// SpectrePro, we need to import `adwaita.h` directly to ensure that the version
...
/// version. This will return false if SpectrePro is configured to not build with
/// libadwaita.
///
