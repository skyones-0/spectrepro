...
///
/// Concretely for SpectrePro, it represents a tree of terminal views. In
...
pub fn SplitTree(comptime V: type) type {
    return struct {
        ...
        /// We use the entire grid size because that's what SpectrePro's
        ...
        pub const getGObjectType = switch (build_config.app_runtime) {
            .gtk => @import("gobject").ext.defineBoxed(
                ...
                .{
                    ...
                    // of the view and append that to `SpectreProSplitTree`.
                    .name = name: {
                        ...
                        const last = if (std.mem.lastIndexOfScalar(
                            ...
                            type_name;
                        assert(last.len > 0);
                        break :name "SpectreProSplitTree" ++ last;
                    },
