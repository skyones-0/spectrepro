...
//!
//!     spectrepro-bench +scrollback-compression --mode=report \
...
//!
//!     hyperfine --warmup 3 \
//!       'spectrepro-bench +scrollback-compression --mode=noop --data=/tmp/scrollback.vt' \
//!       'spectrepro-bench +scrollback-compression --mode=compress --data=/tmp/scrollback.vt' \
//!       'spectrepro-bench +scrollback-compression --mode=incremental --data=/tmp/scrollback.vt' \
//!       'spectrepro-bench +scrollback-compression --mode=restore --data=/tmp/scrollback.vt'
