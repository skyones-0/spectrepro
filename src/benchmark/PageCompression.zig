...
//!
//!     spectrepro-bench +page-compression --mode=report --data=/tmp/pages.raw
//!
//! Measure the cost of exact encoded storage relative to the codec alone:
//!
//!     hyperfine --warmup 3 \
//!       'spectrepro-bench +page-compression --mode=compress --loops=100 --data=/tmp/pages.raw' \
//!       'spectrepro-bench +page-compression --mode=store --loops=100 --data=/tmp/pages.raw'
