...
//! `spectrepro-gen ascii`). The stream is fed to a terminal of the requested
...
//!
//!     spectrepro-gen ascii | head -c 1000000 > /tmp/ascii.vt
//!     hyperfine --warmup 3 \
//!       'spectrepro-bench +terminal-snapshot --mode=encode --loops=20 --data=/tmp/ascii.vt' \
//!       'spectrepro-bench +terminal-snapshot --mode=decode --loops=20 --data=/tmp/ascii.vt'
