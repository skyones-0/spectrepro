...
pub fn run(
    ...
    const signpost_name = "spectrepro";
...
test Benchmark {
    ...
    //
    // /home/runner/work/spectrepro/spectrepro/src/benchmark/Benchmark.zig:165:5: 0x3cd2de1 in decltest.Benchmark (spectrepro-test)
