...
//!   spectrepro-gen styled --seed=42
//!
//!   # Heavily styled ASCII
//!   spectrepro-gen styled --seed=42 --style-rate=0.8
//!
//!   # Unicode-heavy, no styling
//!   spectrepro-gen styled --seed=42 --weight-two=1 --weight-three=1 \
//!     --weight-four=0.5 --grapheme-rate=0.1
//!
//!   # Mixed: styles, Unicode, and hyperlinks
//!   spectrepro-gen styled --seed=42 --style-rate=0.3 --weight-two=0.5 \
