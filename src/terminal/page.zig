...
pub const Cell = packed struct(u64) {
    ...
    pub const CLayout = lib.Packed(Cell, .{ .fields = .{
        .content_tag = .{ .type_name = "SpectreProCellContentTag" },
            ...
            .{ .arms = .{
                ...
                .bg_color_palette = .{ .color_palette = lib.Packed(
                    ...
                    .{ .fields = .{
                        .data = .{
                            .name = "index",
                            .type_name = "SpectreProColorPaletteIndex",
                        },
                        ._pad = .{ .omit = true },
                    } },
                ) },
        ...
        .style_id = .{ .type_name = "SpectreProStyleId" },
        .wide = .{ .type_name = "SpectreProCellWide" },
        .semantic_content = .{ .type_name = "SpectreProCellSemanticContent" },
        ._padding = .{ .omit = true },
    } });
...
test "Page.layout can take a maxed capacity" {
    ...
    // call (relevant to: https://github.com/spectrepro-org/spectrepro/issues/10258)
