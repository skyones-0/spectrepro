...
///
/// When a log callback is installed via spectrepro_sys_set(), messages are
...
/// directly to spectrepro_sys_set(SPECTREPRO_SYS_OPT_LOG, &spectrepro_sys_log_stderr).
///
