...
/// C: SpectreProFormatterTerminalOptions
pub const TerminalOptions = extern struct {
    ...
    /// C: SpectreProFormatterTerminalExtra
    pub const Extra = extern struct {
        size: usize = @sizeOf(Extra),
        palette: bool,
        modes: bool,
