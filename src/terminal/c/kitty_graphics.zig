...
/// C: SpectreProKittyGraphicsImage
pub const ImageHandle = if (build_options.kitty_graphics)
    ?*const Image
else
    ?*const anyopaque;

/// C: SpectreProKittyGraphicsPlacementIterator
...
/// C: SpectreProKittyGraphicsPlacementData
...
/// C: SpectreProKittyPlacementLayer
...
/// C: SpectreProKittyGraphicsPlacementIteratorOption
...
/// C: SpectreProKittyGraphicsPlacementRenderInfo
