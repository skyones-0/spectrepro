...
/// SpectreProPaste and only applies to a clipboard paste.
///
/// C: SpectreProPasteSource
...
/// The sink handed to the C read callback: a SpectreProWriter over the
...
const TerminalPasteCapture = struct {
    ...
    fn clipboardRead(_: Terminal, _: ?*anyopaque, request: *const ClipboardRead) callconv(lib.calling_conv) void {
        ...
        const contents = [_]ClipboardContent{.{
            ...
            .data = .init(@as([]const u8, "SpectrePro")),
        }};
