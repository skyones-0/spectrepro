...
/// C: SpectreProSelectionBuffer
///
/// A caller-provided buffer of selections. This follows the same
/// conventions as SpectreProBuffer: ptr may be NULL with cap 0 to query
/// the required capacity, and len is set to the entries written on
/// success or to the required capacity on SPECTREPRO_OUT_OF_SPACE.
...
/// C: SpectreProTerminalSelectWordOptions
...
/// C: SpectreProTerminalSelectWordBetweenOptions
...
/// C: SpectreProTerminalSelectLineOptions
...
/// C: SpectreProTerminalSelectionFormatOptions
