...
pub const ModeState = struct {
    ...
    pub fn getReport(self: *const ModeState, tag: ModeTag) Report {
        ...
        // SpectrePro's behavior is fixed equivalent to DECECM reset, and DECRQM has a
        ...
        // to SpectrePro's erase-color behavior.
        //
...
const ModeEntry = struct {
    ...
    /// If true, this mode is disabled and SpectrePro will not allow it to be
    /// set or queried. The mode enum still has it, allowing SpectrePro developers
...
/// they're used within SpectrePro or google their values. It is not
/// valuable to redocument them all here.
///
/// NOTE: When adding a new mode entry, also add a corresponding
/// SPECTREPRO_MODE_* macro in include/spectrepro/vt/modes.h.
const entries: []const ModeEntry = &.{
    ...
    .{
        ...
        .value = 5522,
        // The macOS app and libspectrepro-vt can both serve the follow-up
