...
fn genTable() Table {
    ...
    // dcs_passthrough
    {
        ...
        // SpectrePro is UTF-8 only, and DCS payloads carry UTF-8 text
        ...
        // 0xC3 0x9C), and SpectrePro doesn't honor 8-bit C1 controls in
...
test "dcs_passthrough: high bytes are payload data" {
    ...
    // 0xC3 0x9C) and SpectrePro doesn't support 8-bit C1 controls
    // anywhere else.
    for (0x80..0x100) |c| {
