...
pub const Options = struct {
    pub const Artifact = enum {
        /// SpectrePro application
        spectrepro,

        /// libspectrepro-vt, Zig module
        lib,
    };
    ...
    /// the binary. The SpectrePro application itself always builds with
    ...
    pub const Features = packed struct {
        ...
        ///
        /// C API: `spectrepro_snapshot_*` and, together with
        /// `grid_introspection`, `spectrepro_tracked_grid_ref_snapshot`.
        snapshot: bool = true,
        ...
        ///
        /// C API: `spectrepro_formatter_*` and, together with `selection`,
        /// `spectrepro_terminal_selection_format_*`.
        formatter: bool = true,
        ...
        /// disabled.
        ///
        /// C API: `spectrepro_terminal_select_*`,
        /// `spectrepro_terminal_selection_*`, `spectrepro_selection_gesture_*`.
        selection: bool = true,
        ...
        /// terminal.
        ///
        /// C API: `spectrepro_render_state_*`.
        ...
        ///
        /// C API: `spectrepro_key_event_*`, `spectrepro_key_encoder_*`,
        /// `spectrepro_mouse_event_*`, `spectrepro_mouse_encoder_*`,
        /// `spectrepro_focus_encode`, `spectrepro_paste_*`.
        ...
        ///
        /// C API: `spectrepro_grid_ref_*`, `spectrepro_tracked_grid_ref_*`,
        /// `spectrepro_cell_get*`, `spectrepro_row_get*`, and (shared with
        /// `selection`) `spectrepro_terminal_grid_ref` /
        /// `spectrepro_terminal_point_from_grid_ref`.
        grid_introspection: bool = true,

        /// The APC glyph protocol: a SpectrePro extension that lets
        ...
        ///
        /// C API: `spectrepro_kitty_graphics_*`.
