...
pub const Options = struct {
    ...
    kitty_image_storage_limit: usize = switch (build_options.artifact) {
        .spectrepro => 320 * 1000 * 1000, // 320MB

        // libspectrepro we start with a much lower limit since this is an
...
///
/// The declaration order is part of the libspectrepro-vt C ABI. Removed values
...
test "Terminal: setTitle accepts its current value" {
    ...
    try t.setTitle("SpectrePro");
    try t.setTitle(t.getTitle().?);
    try testing.expectEqualStrings("SpectrePro", t.getTitle().?);
}
...
// https://github.com/spectrepro-org/spectrepro/pull/12581
...
// https://github.co/skyones/spectrepro/issues/1400
...
test "Terminal: print multicodepoint grapheme, disabled mode 2027" {
    ...
    // https://github.co/skyones/spectrepro/issues/289
...
test "Terminal: print invalid VS16 non-grapheme" {
    ...
    // https://github.co/skyones/spectrepro/issues/1482
    try t.print('x');
    try t.print(0xFE0F);
...
// https://github.com/spectrepro-org/spectrepro/pull/12596
...
test "Terminal: eraseChars wide char splits proper cell boundaries" {
    ...
    // This is a test for a bug: https://github.com/spectrepro-org/spectrepro/issues/2817
...
test "Terminal: fullReset preserves kitty graphics limits" {
    ...
    const alloc = testing.allocator;
    const temp_dir = "/tmp/spectrepro-kitty-images";
...
// https://github.co/skyones/spectrepro/issues/1607
...
// https://github.co/skyones/spectrepro/issues/272
...
// https://github.co/skyones/spectrepro/issues/723
...
// https://github.co/skyones/spectrepro/issues/1343
