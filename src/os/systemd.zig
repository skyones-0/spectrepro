...
/// service. It will return false if SpectrePro was launched any other way.
///
...
/// systemd notifications. Used by SpectrePro to inform systemd of the state of the
...
/// should never start SpectrePro with the `NOTIFY_SOCKET` environment variable set
