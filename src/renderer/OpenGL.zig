...
fn prepareContext(getProcAddress: anytype) !void {
    ...
    {
        log.warn(
            "OpenGL version is too old. SpectrePro requires OpenGL {d}.{d}",
...
pub fn surfaceInit(surface: *apprt.Surface) !void {
    ...
    switch (apprt.runtime) {
        ...
        apprt.embedded => {
            // TODO(mitchellh): this does nothing today to allow libspectrepro
            // to compile for OpenGL targets but libspectrepro is strictly
