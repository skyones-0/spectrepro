//! App is the primary GUI application for spectrepro. This builds the window,
...
/// This is true if the app that SpectrePro is in is focused. This may
...
/// SpectrePro is initialized but a well behaved apprt should call
...
/// the focus state of the entire app containing SpectrePro changes.
...
/// Call to notify SpectrePro that the color scheme for the app has changed.
