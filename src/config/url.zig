...
test "url regex" {
    ...
    const cases = [_]struct {
        ...
        .{
            .input = "/Users/spectrepro.user/code/example.py",
            .expect = "/Users/spectrepro.user/code/example.py",
        },
        .{
            .input = "/Users/spectrepro.user/code/../example.py",
            .expect = "/Users/spectrepro.user/code/../example.py",
        ...
        .{
            .input = "/Users/spectrepro.user/code/../example.py hello world",
            .expect = "/Users/spectrepro.user/code/../example.py",
        },
        .{
            .input = "../example.py",
        ...
        .{
            .input = "[link](/home/user/spectrepro.user/example)",
            .expect = "/home/user/spectrepro.user/example",
        },
        ...
        .{
            .input = "lib/spectrepro/terminal.zig:42:10",
            .expect = "lib/spectrepro/terminal.zig:42:10",
        },
        .{
        ...
        .{
            .input = "~/.config/spectrepro/config",
            .expect = "~/.config/spectrepro/config",
        },
        .{
            .input = "directory: ~/src/spectrepro-org/spectrepro",
            .expect = "~/src/spectrepro-org/spectrepro",
        },
        .{
        ...
        .{
            .input = "project dir: $PWD/src/spectrepro/main.zig",
            .expect = "$PWD/src/spectrepro/main.zig",
        },
        ...
        .{
            .input = "loaded from .local/share/spectrepro/state.db now",
            .expect = ".local/share/spectrepro/state.db",
        },
        .{
            .input = "../some/where",
            .expect = "../some/where",
        ...
        .{
            .input = "./.config/spectrepro: Needs upstream (main)",
            .expect = "./.config/spectrepro",
        },
        .{
