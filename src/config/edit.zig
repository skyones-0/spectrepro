...
///
/// On macOS, both XDG and AppSupport paths are valid. SpectrePro prioritizes
/// XDG over AppSupport, so we use XDG if it exists, followed by AppSupport
/// if it exists, and finally XDG if neither exist.
