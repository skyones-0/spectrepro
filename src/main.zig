...
const entrypoint = switch (build_config.exe_entrypoint) {
    .spectrepro => @import("main_spectrepro.zig"),
    .helpgen => @import("helpgen.zig"),
    .mdgen_spectrepro_1 => @import("build/mdgen/main_spectrepro_1.zig"),
    .mdgen_spectrepro_5 => @import("build/mdgen/main_spectrepro_5.zig"),
