...
class MockConfig: SpectrePro.Config {
    internal init(backgroundBlur: SpectrePro.Config.BackgroundBlur, backgroundColor: Color, backgroundOpacity: Double) {
    ...
    var _backgroundBlur: SpectrePro.Config.BackgroundBlur
    var _backgroundColor: Color
    var _backgroundOpacity: Double

    override var backgroundBlur: SpectrePro.Config.BackgroundBlur {
        _backgroundBlur
    }
...
struct TerminalViewContainerTests {
    @Test func glassAvailability() async throws {
        ...
        await view.spectreproConfigDidChange(config, preferredBackgroundColor: nil)
