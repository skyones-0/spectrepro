...
struct ConfigTests {
    ...
    @Test(arguments: [
        ("native", SpectrePro.Config.MacOSTitlebarStyle.native),
        ("transparent", SpectrePro.Config.MacOSTitlebarStyle.transparent),
        ("tabs", SpectrePro.Config.MacOSTitlebarStyle.tabs),
        ("hidden", SpectrePro.Config.MacOSTitlebarStyle.hidden),
    ])
    func macosTitlebarStyleValues(raw: String, expected: SpectrePro.Config.MacOSTitlebarStyle) throws {
    ...
    @Test(arguments: [
        ("always", SpectrePro.Config.ResizeOverlay.always),
        ("never", SpectrePro.Config.ResizeOverlay.never),
        ("after-first", SpectrePro.Config.ResizeOverlay.after_first),
    ])
    func resizeOverlayValues(raw: String, expected: SpectrePro.Config.ResizeOverlay) throws {
