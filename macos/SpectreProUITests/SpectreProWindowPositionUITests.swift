//
//  SpectreProWindowPositionUITests.swift
//  SpectreProUITests
//
...
final class SpectreProWindowPositionUITests: SpectreProCustomConfigCase {
    // MARK: - Cascading
    ...
    @MainActor func testWindowCascading() async throws {
        try updateConfig(
            ...
            window-width = 30
            window-height = 10
            title = "SpectreProWindowPositionUITests"
            """
        )
        ...
        // Clean run
        app.launchEnvironment["SPECTREPRO_CLEAR_USER_DEFAULTS"] = "YES"
