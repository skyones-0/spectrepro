...
final class SpectreProThemeTests: SpectreProCustomConfigCase {
    override static var runsForEachTargetApplicationUIConfiguration: Bool {
        true
    }

    let windowTitle = "SpectreProThemeTests"
    ...
    /// https://github.com/spectrepro-org/spectrepro/issues/8282
    @MainActor
    ...
    func testQuickTerminalThemeChange() async throws {
        ...
        let title = "Debug builds of SpectrePro are very slow and you may experience performance problems. Debug builds are only recommended during development."
