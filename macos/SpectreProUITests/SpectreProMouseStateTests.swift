//
//  SpectreProMouseStateTests.swift
//  SpectrePro
//
...
final class SpectreProMouseStateTests: SpectreProCustomConfigCase {
    // https://github.com/spectrepro-org/spectrepro/pull/11276
    @MainActor func testSelectionFocusChange() async throws {
        ...
        let tmpFile = NSTemporaryDirectory() + "spectrepro_test_dummy.txt"
