...
class NonNativeFullscreen: FullscreenBase, FullscreenStyle {
    ...
    func enter() {
        ...
        // lose it (see: https://github.com/spectrepro-org/spectrepro/issues/6999).
        ...
        // https://github.com/spectrepro-org/spectrepro/issues/1996
    ...
    private func fullscreenFrame(_ screen: NSScreen) -> NSRect {
        ...
        if !NSApp.presentationOptions.contains(.autoHideMenuBar) &&
            ...
            // if a bug is reported to SpectrePro we can just advise the user to
            // update.
...
extension Notification.Name {
    static let fullscreenDidEnter = Notification.Name("co.skyones.spectrepro.fullscreenDidEnter")
    static let fullscreenDidExit = Notification.Name("co.skyones.spectrepro.fullscreenDidExit")
}
