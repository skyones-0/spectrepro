// This file contains the configuration types for SpectrePro so that alternate targets
// can get typed information without depending on all the dependencies of SpectreProKit.
