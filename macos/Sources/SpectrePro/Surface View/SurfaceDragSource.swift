            ...
            if operation == [] && !dragCancelledByEscape {
                ...
                if !endsInWindow {
                    NotificationCenter.default.post(
                        ...
                        object: surfaceView,
                        userInfo: [Foundation.Notification.Name.spectreproSurfaceDragEndedNoTargetPointKey: screenPoint]
                    )
                }
            }
...
extension Notification.Name {
    ...
    static let spectreproSurfaceDragEndedNoTarget = Notification.Name("spectreproSurfaceDragEndedNoTarget")

    /// Key for the screen point where the drag ended in the userInfo dictionary.
    static let spectreproSurfaceDragEndedNoTargetPointKey = "endedAtPoint"
}
