...
struct ColorizedSpectreProIcon {
    ...
    let frame: SpectrePro.MacOSIconFrame

    /// Make a custom colorized spectrepro icon.
...
extension ColorizedSpectreProIcon: Codable {
    ...
    init(from decoder: any Decoder) throws {
        ...
        guard version == 0 || version == CodingKeys.currentVersion else {
            throw DecodingError.dataCorrupted(
                DecodingError.Context(
                    ...
                    debugDescription: "Unsupported ColorizedSpectreProIcon version: \(version)"
                )
            )
        }
        ...
        let frame = try container.decode(SpectrePro.MacOSIconFrame.self, forKey: .frame)
...
extension ColorizedSpectreProIcon: Equatable {
