...
class ClipboardConfirmationController: NSWindowController {
    ...
    private(set) var confirmation: SpectrePro.ClipboardConfirmationRequest
    weak private var delegate: ClipboardConfirmationViewDelegate?

    init(
        confirmation: SpectrePro.ClipboardConfirmationRequest,
    ...
    func replaceConfirmation(with confirmation: SpectrePro.ClipboardConfirmationRequest) {
