...
/// Handler for the `send mouse position` AppleScript command defined in `SpectrePro.sdef`.
///
/// Cocoa scripting instantiates this class because the command's `<cocoa>` element
/// specifies `class="SpectreProScriptMousePosCommand"`. The runtime calls
/// `performDefaultImplementation()` to execute the command.
@MainActor
@objc(SpectreProScriptMousePosCommand)
