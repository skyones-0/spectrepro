...
/// Handler for the `input text` AppleScript command defined in `SpectrePro.sdef`.
///
/// Cocoa scripting instantiates this class because the command's `<cocoa>` element
/// specifies `class="SpectreProScriptInputTextCommand"`. The runtime calls
/// `performDefaultImplementation()` to execute the command.
@MainActor
@objc(SpectreProScriptInputTextCommand)
