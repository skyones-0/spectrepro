...
class QuickTerminalWindow: NSPanel {
    ...
    override func awakeFromNib() {
        ...
        self.identifier = .init(rawValue: "co.skyones.spectrepro.quickTerminal")
        ...
        // Keep the panel in the current Space while allowing it over native fullscreen apps.
    ...
    /// bugs in older macOS versions (Ventura): https://github.com/spectrepro-org/spectrepro/pull/8026
    ...
    override func setFrame(_ frameRect: NSRect, display flag: Bool) {
        ...
        //
        // https://github.com/spectrepro-org/spectrepro/pull/8026
