...
class TerminalViewContainer: NSView {
    ...
    func spectreproConfigDidChange(_ config: SpectrePro.Config, preferredBackgroundColor: NSColor?) {
...
extension TerminalViewContainer {
    ...
    struct DerivedConfig: Equatable {
        ...
        init?(config: SpectrePro.Config, preferredBackgroundColor: NSColor?, cornerRadius: CGFloat?) {
