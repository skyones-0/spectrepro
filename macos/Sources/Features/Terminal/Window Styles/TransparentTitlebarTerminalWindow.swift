...
class TransparentTitlebarTerminalWindow: TerminalWindow {
    ...
    private var lastSurfaceConfig: SpectrePro.SurfaceView.DerivedConfig?
    ...
    override func syncAppearance(_ surfaceConfig: SpectrePro.SurfaceView.DerivedConfig) {
    ...
    private func syncAppearanceTahoe(_ surfaceConfig: SpectrePro.SurfaceView.DerivedConfig) {
    ...
    private func syncAppearanceVentura(_ surfaceConfig: SpectrePro.SurfaceView.DerivedConfig) {
