...
class TerminalWindow: NSWindow {
    ...
    override func awakeFromNib() {
        ...
        // Get our saved level
        level = UserDefaults.spectrepro.value(forKey: Self.defaultLevelKey) as? NSWindow.Level ?? .normal
    }
    ...
    /// added.
    static let tabBarIdentifier: NSUserInterfaceItemIdentifier = .init("_spectreproTabBar")
    ...
    func syncAppearance(_ surfaceConfig: SpectrePro.SurfaceView.DerivedConfig) {
        ...
        if !styleMask.contains(.fullScreen) &&
            ...
            if !surfaceConfig.backgroundBlur.isGlassStyle, let appDelegate = NSApp.delegate as? AppDelegate {
                spectrepro_set_window_background_blur(
                    appDelegate.spectrepro.app,
...
extension TerminalWindow {
    private static let closeTabsOnRightMenuItemIdentifier = NSUserInterfaceItemIdentifier("co.skyones.spectrepro.closeTabsOnTheRightMenuItem")
    private static let changeTitleMenuItemIdentifier = NSUserInterfaceItemIdentifier("co.skyones.spectrepro.changeTitleMenuItem")
    private static let tabColorSeparatorIdentifier = NSUserInterfaceItemIdentifier("co.skyones.spectrepro.tabColorSeparator")

    private static let tabColorPaletteIdentifier = NSUserInterfaceItemIdentifier("co.skyones.spectrepro.tabColorPalette")
